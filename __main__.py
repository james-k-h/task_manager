...
#         SCRIPTS_LIST={
#           "coding": [
#             { "name": "Edit Script", "module": "scripts_list.edit_script.edit_script" }
#           ],
#           "study": [
#             { "name": "Study AI", "module": "scripts_list.study.study_ai" }
#           ]
#         }
#         """
#         try:
#             raw = os.getenv("SCRIPTS_LIST")
#             if not raw:
#                 raise ValueError("SCRIPTS_LIST missing from .env")

#             data = json.loads(raw)
#             if not isinstance(data, dict):
#                 raise ValueError("SCRIPTS_LIST must be a JSON object")
...
#             ("Planning", "planning"),
#         ]:
#             self._nav_button(button_frame, display, key)

#     def show_category(self, category, title):
#         self._clear()
...
#         scripts = self.scripts.get(category, [])
#         if not scripts:
#             tk.Label(
#                 self.main_frame,
...
#         """
#         Execute a script as a Python module.
#         """
#         try:
...
#             messagebox.showerror(
#                 "Timeout",
#                 f"{script_name} exceeded 60 seconds",
#             )

#         except Exception as e:
#             messagebox.showerror(
#                 "Error",
#                 f"Failed to execute {script_name}:\n{e}",
#             )
...
#             font=("Arial", 14),
#             bg="#d3d3d3",
#             command=lambda: self.show_category(key, text),
#         )
#         btn.pack(pady=15)

#     def _script_button(self, name, module):
#         btn = tk.Button(
#             self.main_frame,
#             text=name,
#             width=35,
...
#             font=("Arial", 11),
#             bg="#d3d3d3",
#             command=lambda: self.run_script(name, module),
#         )
#         btn.pack(pady=8)
